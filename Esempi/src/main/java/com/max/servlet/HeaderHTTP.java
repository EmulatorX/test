...
public class HeaderHTTP extends HttpServlet {
	private static final long serialVersionUID = -599961088015044802L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<table>");
		out.println("<tr>");
		out.println("<td style=\"width:200px;\">Header Name</td>");
		out.println("<td style=\"width:300px;\">Header Value</td>");
		out.println("</tr>");
